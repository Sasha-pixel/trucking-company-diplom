...
public class DrillDownUtils {
	...
	public enum Views {
		...
		ORDER_ARCHIVE_LIST_VIEW("orderarchivelist"),
		ORDER_ARCHIVE_INFO_VIEW("orderarchiveinfo"),
	...
	public enum ScreenViews {
		...
		ORDER_SCREEN_ORDER_ARCHIVE_LIST_VIEW(Screens.ORDER_SCREEN, Views.ORDER_ARCHIVE_LIST_VIEW),
		ORDER_SCREEN_ORDER_ARCHIVE_INFO_VIEW(Screens.ORDER_SCREEN, Views.ORDER_ARCHIVE_INFO_VIEW),
